...
public class count {
     ...
     * 读取某个文件夹下的所有文件
     */
    public static boolean count(String filepath) throws FileNotFoundException, IOException {
            try {
...
/**
    ...
    public static void main(String[] args) {
            try {
                    count("D:\\eclipse\\新建文件夹\\.metadata\\.plugins\\org.eclipse.wst.server.core"
